...
export default function AdminDashboard() {
    ...
    if (showAdminLogin && !isAdmin) {
        return (
            <div className="premium-bg flex-center">
                <div className="glass-panel scale-in" style={{ maxWidth: '400px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                        ...
                        />
                        <button onClick={loginAdmin} className="btn-primary">Connecter</button>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="premium-bg">
            <div className="home-layout scale-in" style={{ maxWidth: '800px' }}>
                <div className="glass-panel main-panel">
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                        <h1 style={{ margin: 0, fontSize: '1.75rem' }}>Admin Panel</h1>
                        <button onClick={() => { fetchStats(); fetchConfigAndTournament(); }} className="btn-outline" style={{ width: 'auto', padding: '0.5rem 1rem', fontSize: '0.8rem' }}>🔄 Refresh</button>
                    </div>
                    ...
                    {activeTab === 'STATS' && (
                        <>
                            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '1.25rem', marginBottom: '2.5rem' }}>
                                <div style={{ background: 'rgba(46, 204, 113, 0.08)', padding: '1.5rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-accent-green-glow)' }}>
                                    <div style={{ fontSize: '0.7rem', color: 'var(--color-accent-green)', opacity: 0.8, textTransform: 'uppercase', fontWeight: 800, letterSpacing: '1px' }}>REVENUS TOTAUX</div>
                                    <div style={{ fontSize: '1.75rem', fontWeight: 900, color: 'var(--color-accent-green)', marginTop: '0.5rem', fontFamily: 'var(--font-heading)' }}>{calculatedTotalEarnings} DH</div>
                                </div>
                                <div style={{ background: 'rgba(241, 196, 15, 0.08)', padding: '1.5rem', borderRadius: 'var(--radius-md)', border: '1px solid var(--color-accent-gold-glow)' }}>
                                    <div style={{ fontSize: '0.7rem', color: 'var(--color-accent-gold)', opacity: 0.8, textTransform: 'uppercase', fontWeight: 800, letterSpacing: '1px' }}>À ENCAISSER</div>
                                    <div style={{ fontSize: '1.75rem', fontWeight: 900, color: 'var(--color-accent-gold)', marginTop: '0.5rem', fontFamily: 'var(--font-heading)' }}>{totalOwed} DH</div>
                                </div>
